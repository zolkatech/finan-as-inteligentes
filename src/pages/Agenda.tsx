...
export default function Agenda() {
    ...
    const { isConnected, loading: connectionLoading } = useGoogleConnection();
    ...
    return (
        <div className="h-[calc(100vh-100px)] p-6 flex flex-col gap-6">
            {!connectionLoading && !isConnected && (
                <Alert variant="destructive" className="bg-yellow-50 border-yellow-200 text-yellow-800 dark:bg-yellow-900/20 dark:border-yellow-900/50 dark:text-yellow-200">
                    <AlertCircle className="h-4 w-4 stroke-yellow-600 dark:stroke-yellow-400" />
                    <AlertTitle className="text-yellow-800 dark:text-yellow-200">Google Calendar não conectado</AlertTitle>
                    <AlertDescription className="flex items-center justify-between text-yellow-700 dark:text-yellow-300">
                        <span>Para visualizar e sincronizar seus eventos, conecte sua conta do Google.</span>
                        <Link to="/integrations">
                            <Button size="sm" variant="outline" className="ml-4 border-yellow-300 hover:bg-yellow-100 text-yellow-900 dark:border-yellow-700 dark:hover:bg-yellow-900/50 dark:text-yellow-100">
                                Conectar agora
                            </Button>
                        </Link>
                    </AlertDescription>
